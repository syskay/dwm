...
static Key keys[] = {
	...
	{ MODKEY,                       XK_l,      setmfact,       {.f = +0.05} },
        ...
        { MODKEY|Mod4Mask,              XK_j,      incrihgaps,     {.i = +1 } },
        { MODKEY|Mod4Mask,              XK_k,      incrihgaps,     {.i = -1 } },
        { MODKEY|ControlMask,           XK_j,      incrivgaps,     {.i = +1 } },
        { MODKEY|ControlMask,           XK_k,      incrivgaps,     {.i = -1 } },
        { MODKEY|Mod4Mask|ControlMask,  XK_j,      incrohgaps,     {.i = +1 } },
        { MODKEY|Mod4Mask|ControlMask,  XK_k,      incrohgaps,     {.i = -1 } },
        { MODKEY|Mod4Mask|ShiftMask,    XK_j,      incrovgaps,     {.i = +1 } },
        { MODKEY|Mod4Mask|ShiftMask,    XK_k,      incrovgaps,     {.i = -1 } },
